...
-   [Vitesse des changements](https://www.ipcc.ch/languages-2/francais/) → adaptation difficile.
-   [Inégalités](https://www.oxfam.org/fr/reports/climate-equality-report) : 1 % les plus riches $>$ émissions que 50 % les plus pauvres.
...
3.  Dissonance cognitive qui décrit l'état mental conflictuel qui résulte directement de la tension entre le comportement (1) et les préoccupations (2)
...
Le baptême de feu de la journée s'est prolongé en soirée par des échanges collectifs entre étudiants, précédés de la projection d'un documentaire, le tout organisé par l'[ONG Eclosio](https://www.eclosio.ong/).
...
Dans la continuité, la séance a été suivie par la projection du documentaire « L'***Empire de l'or rouge*** », réalisé par l’ONG [Humundi](https://www.inter-reseaux.org/membre/humundi/) (anciennement SOS Faim Belgique). Le film retrace l'épopée mondiale de la tomate, symbole d'un commerce globalisé et révélateur d'enjeux économiques et géopolitiques.
...
#### Cas d'étude n°1 : cas du Djibouti
...
2.  Une Politique Étrangère Pragmatique : Le "Multi-alignement" Face à cette concentration d'intérêts, Djibouti mène une politique étrangère extrêmement habile et pragmatique, souvent qualifiée de "multi-alignement" ou de "diplomatie de location".
...
3.  Défis et Vulnérabilités Cette position enviable n'est pas sans risques :
...
2.  Pourquoi cela arrive-t-il ? Les Causes Profondes Défaut de prise en compte de l'aléa dans les documents d'urbanisme : La carte existe, mais elle n'a pas été intégrée réglementairement dans le plan d'urbanisme, ou des dérogations ont été massivement accordées.
...
3.  Le Rôle Crucial de la Géomatique (SIG) pour Comprendre et Agir Un expert en SIG ne se contente pas de produire la carte ; il peut démontrer l'absurdité de la situation :
...
1.  Le Constat : Une Côte qui Disparaît La côte béninoise, et particulièrement le secteur de Cotonou, subit une érosion sévère et accélérée depuis des décennies.
...
2.  Les Causes Anthropiques : La Perturbation du Transit Sédimentaire Votre description des causes est tout à fait exacte. La dynamique littorale naturelle a été inversée par une série d'aménagements.
...
3.  Inversion de la Dynamique et Preuves Vous avez raison de pointer la période autour de 1965 comme charnière. Les études sédimentologiques et la comparaison de photographies aériennes et satellitaires sur plusieurs décennies le confirment :
...
4.  Réponses et Mitigation Face à cette crise, le Bénin a tenté plusieurs solutions, souvent coûteuses et aux résultats mitigés :
...
1.  Origine du terme "réfugié climatique" Il est inexact de dire que le terme a été "prononcé pour la première fois en Australie" en tant que pays. Sa paternité est généralement attribuée à un rapport des Nations Unies.
...
2.  La position des États-Unis (et d'autres pays) Vrai. Les États-Unis, parmi d'autres nations occidentales (Canada, pays européens), se sont montrés très réticents à adopter le terme juridique de "réfugié climatique".
...
3.  La non-reconnaissance officielle du terme Vrai à ce jour. Il n'existe aucun statut juridique international de "réfugié climatique".
...
## Partim 2 : Introduction aux notions de bases

**Cours** : ***Introduction aux risques et catastrophes à l’ère de l’Anthropocène Enseignant : Nicolas Dendoncker (UNamur)***

**Date** : ***23/09/2025***

**Objectifs de la séance du jours**

-   Clarifier les notions fondamentales : risque, aléa, vulnérabilité, résilience, adaptation, atténuation, urgence complexe.

-   Comprendre le concept d’Anthropocène et ses implications.

-   Explorer les limites planétaires et les enjeux de gouvernance.

-   Initier à la pensée systémique et aux propriétés émergentes des systèmes complexes.

-   Introduire l’économie du donut comme modèle alternatif pour penser durabilité et justice sociale.

### Anthropocène : quand l’humain devient force géologique

-   **Définition** : L’Anthropocène est proposé comme une nouvelle ère géologique où l’humain est le principal facteur de transformation des systèmes terrestres ([Crutzen et Stoermer, 2000](https://www.nature.com/articles/415023a) ).

-   **Débats** :

    -   *Date de début* : non tranchée par l’Union internationale de géologie. Hypothèses : révolution industrielle (\~1750), « grande accélération » (\~1950), agriculture néolithique (\~10 000 ans).

    -   *Indicateurs* : dépôts sédimentaires (lacs, glaces, radionucléides), isotopes (δ18O), plastiques, etc.

-   **Croissance économique infinie** ?

    -   Dogme remis en cause dans un système fermé comme la Terre, où seule l’énergie solaire est vraiment renouvelable.

    -   Depuis les années 1970, l’humanité consomme **plus que ce que la Terre peut régénérer en un an** (Earth Overshoot Day).

-   **Inégalités environnementales** :

    -   Les 1 % les plus riches émettent bien plus de CO₂ que les 50 % les plus pauvres ([Oxfam, 2023](https://www.oxfam.org/fr)).

    -   D’où des propositions de parler de Capitalocène (responsabilité du système économique) ou de Plantationocène (responsabilité des structures coloniales).

-   **Enjeux politiques** :

    -   Concept encore « mollement politique », mais il impose de décloisonner les disciplines et de repenser gouvernance et justice environnementale.

### Les limites planétaires

-   **Concept** : Rockström et al., 2009 (<https://www.stockholmresilience.org/research/planetary-boundaries.html>) définissent 9 processus biophysiques critiques. Dépasser ces seuils → risques de basculements irréversibles.

-   **Exemples** :

    -   Déforestation amazonienne : risque de basculer vers une savane si les précipitations diminuent.

    -   Biodiversité : perte 100 à 1000 fois supérieure au rythme naturel.

-   Pollution plastique : en 2022, une nouvelle limite a été franchie (contamination chimique & plastique).

-   **Boucles de rétroaction** :

    -   Déforestation → baisse humidité des sols → perte de biodiversité → émissions de CO₂ → hausse de température → déforestation accrue.

-   **Lien avec l’économie** : le dépassement des limites planétaires n’est pas seulement écologique, il pose des enjeux sociaux, sanitaires et politiques.

### Exercices pratiques : comprendre la complexité

-   **Jeu en auditoire** :

    -   Chaque étudiant doit rester à égale distance de deux autres → stabilisation spontanée du système après un temps → propriété émergente.

    -   Variante : choisir un ami à approcher et un ennemi à fuir → apparition de sous-groupes.

**Message clé** :

-   Les systèmes complexes (climat, économie, société) produisent des dynamiques impossibles à prévoir par une simple addition des comportements individuels.

-   On ne peut pas « contrôler » ces systèmes mais seulement participer et s’adapter.

### Penser autrement : l’économie du donut

-   **Référence** : Kate Raworth, Doughnut Economics (2017).

-   **Principe** :

    -   Un plafond environnemental : limites planétaires à ne pas dépasser.
    -   Un plancher social : besoins humains fondamentaux (alimentation, santé, énergie, justice).
    -   L’espace sûr et juste pour l’humanité = entre les deux.

**Intérêt** :

-   Combine sciences naturelles (seuils biophysiques) et sciences sociales (justice, équité).

-   Propose une vision systémique où durabilité et justice sociale sont indissociables.

Voir : [Doughnut Economics Action Lab](<https://doughnuteconomics.org/>).

### Conclusion provisoire (séance du jour) du partim

L’Anthropocène oblige à penser :

- L’interdépendance entre environnement, société et économie.
- Les risques comme produits de systèmes complexes.
- La nécessité d’une pensée systémique pour éviter les solutions simplistes.
- Les prochaines séances aborderont plus en détail :
- Les risques spécifiques (climat, santé, migrations).
- Les modes de gouvernance face à l’incertitude.

### Recommandation de lecture pour approfondir :
...
Oxfam (2023). Carbon Inequality Report.
